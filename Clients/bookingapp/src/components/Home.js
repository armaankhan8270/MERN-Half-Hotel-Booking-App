...
const Home = () => {
  ...
  return (
    <div className="mt-20">
      <bttton
        onClick={getAllHotel}
        className="p-6 rounded-3xl text-white mt-20 w-full text-center text-3xl text-center bg-cyan-600 m"
      >
        View All Hotel
      </bttton>
                      ...
                      <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                          ...
                          <p class="leading-relaxed">
                            Resort The Lohias, a division of The Lohias
                            Hospitality Group, is a leading hospitality chain in
